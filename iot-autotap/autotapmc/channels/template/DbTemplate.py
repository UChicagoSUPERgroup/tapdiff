...
# NEW, with things like brightness_sensor
template_dict = {
    ...
    'smart_oven': {'oven_temperature_temperature': 'numeric', 'openclose_door_position': 'bool', 'power_onoff_setting': 'bool', 'lockunlock_setting': 'bool'}, 
    'hue_lights': {'power_onoff_setting': 'bool', 'light_color_color': 'set, [Red, Orange, Yellow, Green, Blue, Violet, White]', 'brightness_level': 'numeric'}, 
    'weather_sensor': {'is_it_raining_condition': 'bool, external', 'current_temperature_temperature': 'numeric, external', 'weather_sensor_weather': 'set, external, [Sunny, Cloudy, Partlycloudy, Raining, Thunderstorms, Snowing, Hailing, Clear]'}, 
    'smart_faucet': {'water_onoff_setting': 'bool'}, 'clock': {'is_it_daytime_time': 'bool, external', 'alarm_ringing_value': 'bool'}, 
    'power_main': {'power_onoff_setting': 'bool'}, 
    'smart_refrigerator': {'openclose_door_position': 'bool', 'current_temperature_temperature': 'numeric, external', 'temperature_control_temperature': 'numeric', 'lockunlock_setting': 'bool'}, 
    'fitbit': {'sleep_sensor_status': 'bool, external', 'heart_rate_sensor_bpm': 'numeric, external'}, 
    'roomba': {'power_onoff_setting': 'bool'}, 
    'location_sensor': {'living_room_alice': 'bool, external', 'living_room_a_family_member': 'bool, external', 'bedroom_a_family_member': 'bool, external', 'bathroom_a_guest': 'bool, external', 'home_a_guest': 'bool, external', 'bedroom_alice': 'bool, external', 'living_room_nobody': 'bool, external', 'home_a_family_member': 'bool, external', 'home_nobody': 'bool, external', 'bedroom_anyone': 'bool, external', 'bathroom_nobody': 'bool, external', 'home_alice': 'bool, external',
    'kitchen_alice': 'bool, external', 'bathroom_anyone': 'bool, external', 'kitchen_a_family_member': 'bool, external', 'bathroom_alice': 'bool, external', 'living_room_bobbie': 'bool, external', 'home_anyone': 'bool, external', 'bedroom_a_guest': 'bool, external', 'home_bobbie': 'bool, external', 'bathroom_a_family_member': 'bool, external', 'living_room_anyone': 'bool, external', 'bedroom_bobbie': 'bool, external', 'kitchen_anyone': 'bool, external', 'bathroom_bobbie': 'bool, external', 'bedroom_nobody': 'bool, external', 'kitchen_a_guest': 'bool, external', 'living_room_a_guest': 'bool, external', 'kitchen_bobbie': 'bool, external', 'kitchen_nobody': 'bool, external'}, 
    'smart_tv': {'volume_level': 'numeric', 'power_onoff_setting': 'bool', 'channel_channel': 'numeric'}, 
    'front_door_lock': {'lockunlock_setting': 'bool'}, 
    'brightness_sensor': {'illuminance_illuminance': 'numeric, external'}, 
    'smoke_detector': {'smoke_detection_condition': 'bool, external'}, 
    'speakers': {'volume_level': 'numeric', 'fm_tuner_frequency': 'numeric', 'power_onoff_setting': 'bool', 'genre_genre': 'set, [Pop, Jazz, Rnb, Hiphop, Rap, Country, News, Stop]'}, 
    'amazon_echo': {'volume_level': 'numeric', 'fm_tuner_frequency': 'numeric', 'genre_genre': 'set, [Pop, Jazz, Rnb, Hiphop, Rap, Country, News, Stop]'}, 
    'living_room_window': {'openclose_window_position': 'bool', 'openclose_curtains_position': 'bool'}, 
    'security_camera': {'detect_motion_status': 'bool, external', 'record_value': 'bool', 'siren_value': 'bool', 'power_onoff_setting': 'bool'}, 
    'bathroom_window': {'openclose_window_position': 'bool', 'openclose_curtains_position': 'bool'}, 
    'smart_plug': {'power_onoff_setting': 'bool'}, 
    'thermostat': {'thermostat_temperature': 'numeric', 'ac_onoff_setting': 'bool', 'current_temperature_temperature': 'numeric, external', 'heater_onoff_setting': 'bool'}
}
...
#     'roomba': {'power_onoff_setting': 'bool'},
#     'amazon_echo': {'fm_tuner_frequency': 'numeric', 'volume_level': 'numeric', 'genre_genre': 'set, [Pop, Jazz, R&B, Hip-Hop, Rap, Country, News]'},
