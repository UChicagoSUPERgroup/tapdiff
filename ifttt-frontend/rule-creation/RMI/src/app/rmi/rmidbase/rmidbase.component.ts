...
@Component({
  selector: 'app-rmidbase',
  templateUrl: './rmidbase.component.html',
  styleUrls: ['./rmidbase.component.css']
})
export class RmidbaseComponent implements OnInit {
    ...
    this.userDataService.getCsrfCookie().subscribe(data => {
      this.router.params.subscribe(params => {
        ...
        if (!this.userDataService.user_id) {
          ...
          this.userDataService.version = params["version"]
          this.userDataService.use_version = true
        } 
